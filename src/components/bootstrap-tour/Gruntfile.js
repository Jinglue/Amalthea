  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      standalone: {
        ...
        src: ["src/js/standalone/tooltip.js", "src/js/standalone/popover.js", "build/js/<%= pkg.name %>.js"],
    ...
    less: {
      "default": {
        files: {
          ...
          "build/css/<%= pkg.name %>-standalone.css": ["src/less/standalone/bootstrap.less", "src/less/<%= pkg.name %>.less"]
        }
      },
      min: {
        options: {
        ...
        files: {
          ...
          "build/css/<%= pkg.name %>-standalone.min.css": ["src/less/standalone/bootstrap.less", "src/less/<%= pkg.name %>.less"]
        }
      }
    },
    uglify: {
