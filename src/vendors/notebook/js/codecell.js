...
define([
    ...
    CodeCell.prototype.get_kernel = function () {
        return this.kernel;
    };
     ...
     * @method execute
     */
    CodeCell.prototype.execute = function (stop_on_error, myCallbacks) {
        if (!this.kernel || !this.kernel.is_connected()) {
            //console.log("Can't execute, kernel is not connected.");
            return;
        }
        var run_text;
        if (this.get_sct() && this.get_sct_method() === 0) {
          run_text = this.get_pretext() + '\n' + this.get_text() + '\n' + this.get_sct();
        } else {
          run_text = this.get_pretext() + '\n' + this.get_text();
        }
        if (!run_text) {
            //console.log("Can't execute, no code string.");
            return;
        }
        ...
        var callbacks = this.get_callbacks(myCallbacks);
        this.last_msg_id = this.kernel.execute(run_text, callbacks, {silent: false, store_history: true,
     ...
     */
    CodeCell.prototype.get_callbacks = function (newCallbacks) {
        var that = this;
        if (newCallbacks) {
            newCallbacks(that.output_area, this.SCT, arguments);
        }
        return {
            shell : {
    ...
    CodeCell.prototype.set_endcursor = function () {
        var nlines = this.code_mirror.lineCount();
        var last_line = this.code_mirror.getLine(nlines-1);
        this.code_mirror.setCursor(nlines-1, last_line.length);
        this.code_mirror.focus();
    }
	...
	CodeCell.prototype.get_samplecode = function () {
        return this.SampleCode;
    };
	
	CodeCell.prototype.set_samplecode = function (code) {
        return this.SampleCode = code;
    };
  
  	CodeCell.prototype.reset_text = function () {
        return this.code_mirror.setValue(this.SampleCode);
    };
	...
	CodeCell.prototype.get_title = function () {
        return this.Title;
    };
	
	CodeCell.prototype.set_title = function (code) {
        return this.Title = code;
    };
    
    CodeCell.prototype.get_pretext = function () {
        return this.PreText;
    };
    
    CodeCell.prototype.set_pretext = function (code) {
        return this.PreText = code;
    };
    
    CodeCell.prototype.get_solution = function () {
        return this.Solution;
    };
    
    CodeCell.prototype.set_solution = function (code) {
        return this.Solution = code;
    };
    
    CodeCell.prototype.get_sct = function () {
        return this.SCT;
    };
    
    CodeCell.prototype.set_sct = function (code) {
        return this.SCT = code;
    };
  
    CodeCell.prototype.get_sct_method = function () {
        return this.SCTMethod;
    };
    
    CodeCell.prototype.set_sct_method = function (code) {
        return this.SCTMethod = code;
    };
    
    CodeCell.prototype.get_hint = function () {
        return this.Hint;
    };
    
    CodeCell.prototype.set_hint = function (code) {
        return this.Hint = code;
    };
  
    CodeCell.prototype.get_lang = function () {
        var langStr = {
            python: {
              lang: 'python',
              title:'Python 3',
        ...
        if(this.lang && langStr[this.lang]) {
          return langStr[this.lang];
        } else {
					return this.lang;
				}
    };
    
    CodeCell.prototype.set_lang = function (lang) {
